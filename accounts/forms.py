...
class SignUpForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'first_name': forms.TextInput(attrs={'class': 'form-control', 'placeholder': '실명을 입력하세요'}),
...
class OnboardingForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'first_name': forms.TextInput(attrs={'class': 'form-control', 'placeholder': '홍길동', 'required': True}),
            'session_info': forms.TextInput(attrs={'class': 'form-control', 'placeholder': '예: 2기 / 평일반', 'required': True}),
            'phone_number': forms.TextInput(attrs={'class': 'form-control', 'placeholder': '010-0000-0000', 'required': True}),
        }